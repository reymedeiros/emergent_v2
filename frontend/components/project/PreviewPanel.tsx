    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1">
          ...
          >
            <RefreshCw className="w-4 h-4" style={{ color: colors.mutedForeground }} />
          </button>
          <button
          ...
          >
            <ExternalLink className="w-4 h-4" style={{ color: colors.mutedForeground }} />
          </button>
          <button
            onClick={onClose}
            className="p-2 rounded-lg hover:bg-white/5 transition-colors"
          ...
          >
            <X className="w-4 h-4" style={{ color: colors.mutedForeground }} />
          </button>
        </div>
      </div>
